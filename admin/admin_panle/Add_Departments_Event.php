              ...
              <div class="main-page">
                    <div class="container-fluid">
                        <div class="row page-title-div">
                            <div class="col-md-10">
                                <h2 class="title">Saurashtra University Departments Event Management System</h2>
...
$sql = "SELECT * FROM Departments_Event";
                            ...
                            <tr>
                                ...
                                <td>
                                    <?php if ($row['image_path']) : ?>
                                        <img src="<?php echo $row['image_path']; ?>" alt="Event Image" style="width: 50px; height: 50px;" />
                                    <?php else : ?>
                                        No Image
                                    <?php endif; ?>
                                </td>
