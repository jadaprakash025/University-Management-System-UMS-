...
if(isset($_POST['submit'])){
	...
	$target = "studentAdd/upload_images/".basename($image);
...
<body>
	...
	<div class="container">
<a href="https://lexacademy.inx" target="_blank"><img src="https://codingcuxsh.com/uploads/logo/logo_61b79976c34f5.png" alt="" width="350px" > </a><br><hr>
...
?>
	...
	<a href="u_Admission.php" class="btn btn-danger"><i class="fa fa-arrow-left"></i> Back</a>
	<button class="btn btn-success" type="button" data-toggle="modal" data-target="#myModal">
  <i class="fa fa-plus"></i> Add New Student
  </button>
  

  <form method="post" action="studentAdd/export.php">
  <button type="submit" name="export" class="btn rounded-pill btn-info pull-right">
                              <span class="tf-icons bx bx-down-arrow-alt"value="Export Data"></span>&nbsp; Secondary
                            </button>
     <!-- <input type="submit" name="export" class="btn btn-info pull-right" value="Export Data" /> -->
    </form>

  <!-- <a href="logout.php" class="btn btn-success pull-right"><i class="fa fa-arrow-left"></i> Logout</a> -->
...
<div id='$id' class='modal fade' role='dialog'>
  <div class='modal-dialog'>
    ...
    <div class='modal-content'>
      ...
      <div class='modal-body'>
        <a href='u_studentAdd.php?id=$id' class='btn btn-danger' style='margin-left:250px'>Delete</a>
      </div>
			...
			<div class='container' id='profile'> 
				<div class='row'>
					<div class='col-sm-4 col-md-2'>
						<img src='studentAdd/upload_images/$image' alt='' style='width: 150px; height: 150px;' ><br>
...
<div id='edit$id' class='modal fade' role='dialog'>
  <div class='modal-dialog'>
    ...
    <div class='modal-content'>
      ...
      <div class='modal-body'>
        <form action='u_studentAdd.php?id=$id' method='post' enctype='multipart/form-data'>
		...
		<input type='text' class='form-control' name='staff_id' maxlength='12' placeholder='Enter 12-digit Staff Id' value='$staffCard'>
        	...
        	<div class='form-group'>
        		<label>Image</label>
        		<input type='file' name='image' class='form-control'>
        		<img src = 'studentAdd/upload_images/$image' style='width:50px; height:50px'>
        	</div>
