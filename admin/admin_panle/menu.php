 ...
 <aside id="layout-menu" class="layout-menu menu-vertical menu bg-menu-theme">
          <div class="app-brand demo">
            <a href="index.php" class="app-brand-link">
              ...
              <span class="app-brand-text demo menu-text fw-bolder ms-2" style=" text-transform: uppercase;">S❤️UMS</span>
            </a>
          ...
          <ul class="menu-inner py-1">
            ...
            <li class="menu-header small text-uppercase">
              <span class="menu-header-text">Show Info</span>
            </li>
             
            <li class="menu-item">
              <a href="javascript:void(0);" class="menu-link menu-toggle">
              <i class="menu-icon tf-icons bx bx-support"></i>
                <div data-i18n="Form Layouts">Contact Us</div>
              </a>
              <ul class="menu-sub">
                <li class="menu-item">
                  <a href="U_Contact.php" class="menu-link">
                    <div data-i18n="Vertical Form">University Contact</div>
                  </a>
                </li>
                <li class="menu-item">
                  <a href="S_Of_E_Contact.php" class="menu-link">
                    <div data-i18n="Horizontal Form">Departments Contact</div>
                  </a>
                </li> 
              </ul>
            </li>
            ...
            <li class="menu-item">
              <a href="u_Admission.php" class="menu-link">
                <i class="menu-icon tf-icons bx bx-file"></i>
                <div data-i18n="Basic">Admission Enquiry</div>
              </a>
            </li>
            ...
            <li class="menu-item">
              ...
              <ul class="menu-sub">
                <!-- <li class="menu-item">
                  <a href="Add_Event.php" class="menu-link">
                    <div data-i18n="Vertical Form">Add University Event</div>
                  </a>
                </li> -->
                <li class="menu-item">
                  <a href="Add_Departments_Teachers.php" class="menu-link">
                    <div data-i18n="Horizontal Form">Add Departments Teachers</div>
                  </a>
                </li>
              </ul>
            </li>
             ...
             <li class="menu-item">
              ...
              <i class="menu-icon tf-icons bx bx-copy"></i>
                <div data-i18n="Form Layouts">Courses</div>
              </a>
              <ul class="menu-sub">
                <!-- <li class="menu-item">
                  <a href="Add_Event.php" class="menu-link">
                ...
                <li class="menu-item">
                  <a href="Add_Departments_Courses.php" class="menu-link">
                    <div data-i18n="Horizontal Form">Add Departments Course</div>
                  </a>
                </li>
              </ul>
            </li>
            ...
            <li class="menu-item">
              <a href="javascript:void(0);" class="menu-link menu-toggle">
              <i class="menu-icon tf-icons bx bx-copy"></i>
                <div data-i18n="Form Layouts">Events</div>
              </a>
              <ul class="menu-sub">
                <li class="menu-item">
                  <a href="Add_Event.php" class="menu-link">
                ...
                <li class="menu-item">
                  <a href="Add_Departments_Event.php" class="menu-link">
                    <div data-i18n="Horizontal Form">Add Departments Event</div>
                  </a>
                </li>
              </ul>
            </li>
            ...
            <li class="menu-item">
              <a href="javascript:void(0);" class="menu-link menu-toggle">
              <i class="menu-icon tf-icons bx bx-crown"></i>
                <div data-i18n="Form Layouts">Noice</div>
              </a>
              <ul class="menu-sub">
                <!-- <li class="menu-item">
                  <a href="Add_Event.php" class="menu-link">
                ...
                <li class="menu-item">
                  <a href="Add_Notic.php" class="menu-link">
                    <div data-i18n="Horizontal Form">Add Departments Notic</div>
                  </a>
                </li>
              </ul>
            </li>
            ...
            <li class="menu-header small text-uppercase">
              <span class="menu-header-text">Studentt</span>
            </li>

            <li class="menu-item">
              <a href="u_studentAdd.php" class="menu-link">
                <i class="menu-icon tf-icons bx bx-collection"></i>
                <div data-i18n="Basic">Add New student</div>
              </a>
            </li>
            ...
            <li class="menu-item">
              <a href="u_result.php" class="menu-link">
                <i class="menu-icon tf-icons bx bx-detail"></i>
                <div data-i18n="Basic">Add Result</div>
              </a>
            </li>
