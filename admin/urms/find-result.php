                    ...
                    <div class="panel login-box">
                        <div class="panel-heading">
                            <div class="panel-title text-center">
                                <h4> University Result Management System</h4>
                            </div>
                        </div>
...
{   ?>
                                ...
                                <div class="form-group">
                                    <label for="rollid">Enter your Seat No</label>
                                ...
                                <div class="col-sm-6">
                                    <a href="http://localhost/ums/index.php">Back to Home</a>
                                </div>
                            </form>
                    ...
                    <!-- /.panel -->
                    <p class="text-muted text-center"><small>Copyright © <a href="#">jada prakash</a> 2024</small></p>
                </div>
