...
<html lang="en">
    <head>
        ...
        <link rel="stylesheet" href="../urms\css/bootstrap.css" media="screen" >
        ...
        <link rel="stylesheet" href="../urms\css/prism/prism.css" media="screen" > <!-- USED FOR DEMO HELP - YOU CAN REMOVE IT -->
                    ...
                    <div class="main-page">
                        <div class="container-fluid">
                            <div class="row page-title-div">
                                <div class="col-md-6">
                                    <h2 class="title">Create Student Stream</h2>
                                </div>
                                            ...
                                            <div class="panel-body">
                                                ...
                                                <form method="post">
                                                    <div class="form-group has-success">
                                                       ...
                                                       <div class="form-group has-success">
                                                        <label for="success" class="control-label">Stream Name in Numeric</label>
                                                        <div class="">
