                ...
                <div class="main-page">
                    <div class="container-fluid">
                        <div class="row page-title-div">
                            <div class="col-sm-6">
                                <h2 class="title">Student Result Management System</h2>
                        ...
                        <div class="container-fluid">
                            <div class="row">
                                <div class="col-lg-3 col-md-3 col-sm-6 col-xs-12">
                                    <a class="dashboard-stat bg-primary" href="..\urms\manage-students.php">
                                        <?php
...
?>
                                ...
                                <div class="col-lg-3 col-md-3 col-sm-6 col-xs-12">
                                    <a class="dashboard-stat bg-danger" href="..\urms\manage-subjects.php">
                                        <?php
...
?>
                                ...
                                <div class="col-lg-3 col-md-3 col-sm-6 col-xs-12">
                                    <a class="dashboard-stat bg-warning" href="..\urms\manage-classes.php">
                                        <?php
...
?>
                                        ...
                                        <span class="name">Total Stream listed</span>
                                ...
                                <div class="col-lg-3 col-md-3 col-sm-6 col-xs-12">
                                    <a class="dashboard-stat bg-success" href="..\urms\manage-results.php">
                                        <?php
